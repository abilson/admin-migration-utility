...
namespace AdminMigrationUtility.CustomPages.Models
{
	public class WorkerQueueRecordModel
	{
		...
		public WorkerQueueRecordModel(DataRow row, ISqlQueryHelper sqlQueryHelper)
		{
			SetPropertiesFromDataRowAsync(row, sqlQueryHelper);
		}

		private void SetPropertiesFromDataRowAsync(DataRow row, ISqlQueryHelper sqlQueryHelper)
		{
